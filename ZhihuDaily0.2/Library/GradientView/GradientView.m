...
- (id)initWithFrame:(CGRect)frame type:(int) type{
    ...
    if (self) {
        ...
        }else if (type == TRANSPARENT_UPSIDE_GRADIENT_TYPE){
            [self insertUpsideTransparentGradient];
        } else {
...
//Transparent Gradient Layer
- (void) insertUpsideTransparentGradient {
    UIColor *colorOne = [UIColor colorWithRed:(19/255.0)  green:(26/255.0)  blue:(32/255.0)  alpha:1.0];
    UIColor *colorTwo = [UIColor colorWithRed:(19/255.0)  green:(26/255.0)  blue:(32/255.0)  alpha:0.0];
    NSArray *colors = [NSArray arrayWithObjects:(id)colorOne.CGColor, colorTwo.CGColor, nil];
    NSNumber *stopOne = [NSNumber numberWithFloat:0.0];
    NSNumber *stopTwo = [NSNumber numberWithFloat:1.0];
    NSArray *locations = [NSArray arrayWithObjects:stopOne, stopTwo, nil];
